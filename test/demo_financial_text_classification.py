...
for example_key, example_value in examples_data.items():
    message.append({"role": "user", 'content': example_value})
    message.append({"role": "assistant", 'content': example_key})
...
for q in questions:
    res: ChatCompletion | Stream[ChatCompletionChunk] = client.chat.completions.create(
        model='qwen3-max',
